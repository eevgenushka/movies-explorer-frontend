      ...
      <div className="about-me__container">
        <div className="about-me__description">
          ...
          <p className="about-me__text">
            Я живу в Самаре и работаю в Райффайзенбанке. Именно работа в банке сподвигла меня на смену детельности, так как у нас сильные IT специалисты. Обожаю путешествовать и изучаю английский язык.
          </p>
          <a
